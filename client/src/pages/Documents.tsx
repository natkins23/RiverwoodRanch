              ...
              <div className="max-w-md mx-auto bg-white rounded-lg shadow-md overflow-hidden p-8">
                ...
                <p className="text-sm text-gray-600 mb-8 text-center">
                  ...
                  <span className="text-xs text-gray-500">
                    Property owners and board members have different access
                    levels.
                  </span>
                </p>
        ...
        <section className="py-16 bg-[#F5F5DC] bg-opacity-50 min-h-screen">
          <div className="container mx-auto px-6">
            <div className="flex flex-col md:flex-row items-center mb-8">
              <h2 className="text-3xl font-bold text-[#2C5E1A] mb-4 md:mb-0">
                Ranch Documents
              </h2>
            </div>
                ...
                <div className="col-span-3 text-center py-10">
                  <p className="text-gray-500">
                    {activeTab !== "all"
                      ...
                      : "No documents found."}
                    {accessLevel === "admin" &&
                      " You can upload new documents using the button below."}
                  </p>
                </div>
              )}
            </div>
            ...
            {accessLevel === "admin" && (
              <div className="mt-12 text-center">
                <Dialog>
                  ...
                  <DialogContent>
                    <DialogHeader>
                      <DialogTitle className="text-[#2C5E1A]">
                        Upload New Document
                      </DialogTitle>
                      <DialogDescription>
                        As a board member, you can upload new documents for the
                        community.
                      </DialogDescription>
                    </DialogHeader>
