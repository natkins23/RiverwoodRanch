  ...
  const content = !isAuthenticated ? (
    <section className="py-16 bg-[#F5F5DC] bg-opacity-50 min-h-screen">
      <div className="container mx-auto px-6">
        <h2 className="text-3xl font-bold mb-8 text-center text-[#2C5E1A]">Riverwood Ranch Archives</h2>
        <p className="text-center max-w-3xl mx-auto mb-12">
          This section contains all archived documents for Riverwood Ranch. Please enter your PIN to access these documents.
        </p>
    ...
    <section className="py-16 bg-[#F5F5DC] bg-opacity-50 min-h-screen">
      <div className="container mx-auto px-6">
        <h2 className="text-3xl font-bold mb-8 text-center text-[#2C5E1A]">Riverwood Ranch Archives</h2>
        <p className="text-center max-w-3xl mx-auto mb-12">
          Access all archived documents related to Riverwood Ranch. These resources provide historical guidelines, policies, and other essential information for property owners.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {isLoading ? (
            ...
            <div className="col-span-3 text-center py-10">
              <p className="text-gray-500">No documents found in the archives.</p>
            </div>
          )}
        </div>
